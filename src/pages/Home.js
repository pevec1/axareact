      ...
      <section className="work-as work">
        <div className="container">
          ...
          <p>
            ...
            <br />
            <strong>! начинающий программист на языке javascript</strong>
            <br />
          ...
          <p>
            ...
            языков и умею соединять бэкенд и фронтенд, а также разрабатывать
            сайты по модели Логика-База Данных-Интерфейс с помощью
            Объектно-Ориентированного Программирования.
            <br />
            Изучил курс «Javascript-программирование для начинающих» в
            Нетологии. Теперь решил продолжить развитие карьеры в
            программировании на javascript в frontend стеке. Рассматриваю
            проекты в сфере IT, экономики и маркетинга, и изучении атома.
          </p>
          <p>
            Заинтересованы в работе со мной ? ?<br />
            Отправьте письмо здесь и ждите ответа.
          </p>
          <div>
            <a
